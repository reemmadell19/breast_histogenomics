# File: train_uni_bbb_cleaned.py
# UNI Baseline Model Training with Batch Balancing (BBB) - Cleaned Version
...
# Configuration - CHANGE MODEL_NAME HERE TO SWITCH BETWEEN UNI VARIANTS
MODEL_NAME = "uni2-h"  # Options: "uni" (1024-dim) or "uni2-h" (1536-dim)

# Set feature dimension based on model
MODEL_CONFIGS = {
    "uni": {"input_dim": 1024},
    "uni2-h": {"input_dim": 1536}
}
...
CONFIG = {
    ...
    "experiment_type": "bbb",
    "input_dim": MODEL_CONFIGS[MODEL_NAME]["input_dim"],
    "batch_size": 1,
    "num_classes": 2,
    "lr": 1e-4,
    "num_epochs": 10,
    ...
    "train_csv": f"data/manifests/train_features_{MODEL_NAME}.csv",
    "val_csv": f"data/manifests/val_features_{MODEL_NAME}.csv"
}
...
def main():
    ...
    print("📊 Compare with ResNet50 and H-Optimus results")
