...
def load_virchow2_model():
    ...
    try:
        ...
        model = model.eval()
        print("Virchow-2 loaded successfully")
    ...
    print("\n" + "="*60)
    print("VIRCHOW-2 MODEL LOADED SUCCESSFULLY")
    print(f"Feature dimension: {feature_dim} (class token)")
    print("Architecture: ViT-H/14 with SwiGLU")
    print("="*60)
...
def extract_features_from_bcrnet(h5_path, out_path):
    ...
    if images:
        ...
        if actual_shape != expected_shape:
            print(f"Warning: Feature shape mismatch!")
...
if __name__ == "__main__":
        ...
        for sample_file in sample_files[:2]:  # Check first 2 files
            try:
                ...
                if actual_dim == 1280:
                    ...
                    print(f"   Note: Expected 1280, got {actual_dim}")
            except Exception as e:
    ...
    print(f"Estimated processing time: ~20 hours")
