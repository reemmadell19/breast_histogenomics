...
def analyze_predictions_by_rs_score(csv_path, output_dir='test_results_cls_updated'):
    """
    ...
    ax.set_title('Model Accuracy by RS Score Range (Internal', fontsize=15, fontweight='bold')
    ax.set_xticks(x_pos)
    ...
    ax.set_title('Predictions vs RS Scores (Internal)', fontsize=15, fontweight='bold')
    ...
    ax.set_title('Distribution of Misclassified Cases (Internal)', fontsize=15, fontweight='bold')
    ax.legend(loc='best', fontsize=11)
    ax.grid(True, alpha=0.3, axis='y')
    ...
    ax.set_title('Performance by RS Score Quartiles (Internal)', fontsize=15, fontweight='bold')
    ax.set_xticks(x_pos)
...
if __name__ == "__main__":
    # Updated paths for internal test set
    csv_file = "test_results_cls_updated/h-optimus_attention_20250914_231455_20250918_154542/all_predictions_detailed.csv"
    output_directory = "test_results_cls_updated"
    
    # Run the analysis with the new paths
    analyze_predictions_by_rs_score(csv_file, output_dir=output_directory)