...
def test_individual_folds(model_folder, test_csv, output_dir=None):
    ...
    if output_dir is None:
        ...
        output_dir = f"test_results_cls/{model_name}_{timestamp}"
...
# python test_cls/inference_cls.py --model-folder results_classification_cv/bestf_h-optimus_acmil_20250904_134437 --test-csv data/manifests/test_features_h-optimus.csv

# h-optimus acmil, cross
# python test_cls/inference_cls.py --model-folder results_classification_cv/best_h-optimus_acmil_20250904_113517 --test-csv data/manifests/test_features_h-optimus.csv
...
# python test_cls/inference_cls.py --model-folder results_classification_cv/h-optimus_acmil_20250902_193855 --test-csv data/manifests/test_features_h-optimus.csv

# h-optimus clam, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/h-optimus_clam_20250904_160103 --test-csv data/manifests/test_features_h-optimus.csv

# h-optimus attention, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/h-optimus_attention_20250904_145044 --test-csv data/manifests/test_features_h-optimus.csv

# virchow2 acmil, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/virchow2_acmil_20250904_150000 --test-csv data/manifests/test_features_virchow2.csv

# virchow2 clam, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/virchow2_clam_20250904_160938 --test-csv data/manifests/test_features_virchow2.csv

# virchow2 attention, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/virchow2_attention_20250904_165125 --test-csv data/manifests/test_features_virchow2.csv

# uni2-h acmil, focal, hidden_dim = 64
# python test_cls/inference_cls.py --model-folder results_classification_cv/uni2-h_acmil_20250904_154233 --test-csv data/manifests/test_features_uni2-h.csv

# uni2-h acmil, focal, hidden_dim = 48, best so far (auc = 0.8338)
# python test_cls/inference_cls.py --model-folder results_classification_cv/uni2-h_acmil_20250904_150045 --test-csv data/manifests/test_features_uni2-h.csv

# uni2-h clam, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/uni2-h_clam_20250904_161003 --test-csv data/manifests/test_features_uni2-h.csv

# uni2-h attention, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/uni2-h_attention_20250904_165149 --test-csv data/manifests/test_features_uni2-h.csv

# conch acmil, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/conch_acmil_20250904_150112 --test-csv data/manifests/test_features_conch.csv

# conch clam, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/conch_clam_20250904_161028 --test-csv data/manifests/test_features_conch.csv

# conch attention, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/conch_attention_20250904_165217 --test-csv data/manifests/test_features_conch.csv

# resnet18 acmil, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/resnet18_acmil_20250904_150222 --test-csv data/manifests/test_features_resnet18.csv

# resnet18 clam, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/resnet18_clam_20250904_161048 --test-csv data/manifests/test_features_resnet18.csv

# resnet18 attention, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/resnet18_attention_20250904_165232 --test-csv data/manifests/test_features_resnet18.csv

# resnet50 acmil, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/resnet50_acmil_20250904_152341 --test-csv data/manifests/test_features_resnet50.csv

# resnet50 clam, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/resnet50_clam_20250904_161110 --test-csv data/manifests/test_features_resnet50.csv

# resnet50 attention, focal
# python test_cls/inference_cls.py --model-folder results_classification_cv/resnet50_attention_20250904_165356 --test-csv data/manifests/test_features_resnet50.csv
